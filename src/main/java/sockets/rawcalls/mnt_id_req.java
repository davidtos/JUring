...
public class mnt_id_req {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_INT.withName("spare"),
        uring_syscalls_h.C_LONG_LONG.withName("mnt_id"),
        uring_syscalls_h.C_LONG_LONG.withName("param"),
    ...
    private static final long spare$OFFSET = $LAYOUT.byteOffset(groupElement("spare"));
    ...
    private static final long param$OFFSET = $LAYOUT.byteOffset(groupElement("param"));
