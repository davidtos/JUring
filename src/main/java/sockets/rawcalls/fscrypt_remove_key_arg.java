...
public class fscrypt_remove_key_arg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_INT.withName("removal_status_flags"),
        MemoryLayout.sequenceLayout(5, uring_syscalls_h.C_INT).withName("__reserved")
    ...
    private static final long removal_status_flags$OFFSET = $LAYOUT.byteOffset(groupElement("removal_status_flags"));
