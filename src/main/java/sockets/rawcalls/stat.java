...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG.withName("st_dev"),
        uring_syscalls_h.C_LONG.withName("st_ino"),
        uring_syscalls_h.C_INT.withName("st_mode"),
        uring_syscalls_h.C_INT.withName("st_nlink"),
        uring_syscalls_h.C_INT.withName("st_uid"),
        uring_syscalls_h.C_INT.withName("st_gid"),
        uring_syscalls_h.C_LONG.withName("st_rdev"),
        uring_syscalls_h.C_LONG.withName("__pad1"),
        uring_syscalls_h.C_LONG.withName("st_size"),
        uring_syscalls_h.C_INT.withName("st_blksize"),
        uring_syscalls_h.C_INT.withName("__pad2"),
        uring_syscalls_h.C_LONG.withName("st_blocks"),
        timespec.layout().withName("st_atim"),
        timespec.layout().withName("st_mtim"),
        timespec.layout().withName("st_ctim"),
        MemoryLayout.sequenceLayout(2, uring_syscalls_h.C_INT).withName("__glibc_reserved")
    ).withName("stat");
