...
public class open_how {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_LONG_LONG.withName("mode"),
        uring_syscalls_h.C_LONG_LONG.withName("resolve")
    ).withName("open_how");
    ...
    private static final long resolve$OFFSET = $LAYOUT.byteOffset(groupElement("resolve"));
