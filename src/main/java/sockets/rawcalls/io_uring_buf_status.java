...
public class io_uring_buf_status {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("buf_group"),
        uring_syscalls_h.C_INT.withName("head"),
        MemoryLayout.sequenceLayout(8, uring_syscalls_h.C_INT).withName("resv")
    ...
    private static final long buf_group$OFFSET = $LAYOUT.byteOffset(groupElement("buf_group"));
