...
public class group_req {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("gr_interface"),
    ...
    private static final long gr_interface$OFFSET = $LAYOUT.byteOffset(groupElement("gr_interface"));
    ...
    private static final long gr_group$OFFSET = $LAYOUT.byteOffset(groupElement("gr_group"));
