...
public class elf_prpsinfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_CHAR.withName("pr_state"),
        uring_syscalls_h.C_CHAR.withName("pr_sname"),
        uring_syscalls_h.C_CHAR.withName("pr_zomb"),
        uring_syscalls_h.C_CHAR.withName("pr_nice"),
        MemoryLayout.paddingLayout(4),
        uring_syscalls_h.C_LONG.withName("pr_flag"),
        uring_syscalls_h.C_INT.withName("pr_uid"),
        uring_syscalls_h.C_INT.withName("pr_gid"),
        uring_syscalls_h.C_INT.withName("pr_pid"),
        uring_syscalls_h.C_INT.withName("pr_ppid"),
        uring_syscalls_h.C_INT.withName("pr_pgrp"),
        uring_syscalls_h.C_INT.withName("pr_sid"),
        MemoryLayout.sequenceLayout(16, uring_syscalls_h.C_CHAR).withName("pr_fname"),
        MemoryLayout.sequenceLayout(80, uring_syscalls_h.C_CHAR).withName("pr_psargs")
    ...
    private static final long pr_state$OFFSET = $LAYOUT.byteOffset(groupElement("pr_state"));
    ...
    private static final long pr_sname$OFFSET = $LAYOUT.byteOffset(groupElement("pr_sname"));
    ...
    private static final long pr_zomb$OFFSET = $LAYOUT.byteOffset(groupElement("pr_zomb"));
    ...
    private static final long pr_nice$OFFSET = $LAYOUT.byteOffset(groupElement("pr_nice"));
    ...
    private static final long pr_flag$OFFSET = $LAYOUT.byteOffset(groupElement("pr_flag"));
    ...
    private static final long pr_uid$OFFSET = $LAYOUT.byteOffset(groupElement("pr_uid"));
    ...
    private static final long pr_gid$OFFSET = $LAYOUT.byteOffset(groupElement("pr_gid"));
    ...
    private static final long pr_pid$OFFSET = $LAYOUT.byteOffset(groupElement("pr_pid"));
    ...
    private static final long pr_ppid$OFFSET = $LAYOUT.byteOffset(groupElement("pr_ppid"));
    ...
    private static final long pr_pgrp$OFFSET = $LAYOUT.byteOffset(groupElement("pr_pgrp"));
    ...
    private static final long pr_sid$OFFSET = $LAYOUT.byteOffset(groupElement("pr_sid"));
    ...
    private static final long pr_fname$OFFSET = $LAYOUT.byteOffset(groupElement("pr_fname"));
    ...
    private static final long pr_psargs$OFFSET = $LAYOUT.byteOffset(groupElement("pr_psargs"));
