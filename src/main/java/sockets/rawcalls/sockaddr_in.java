...
public class sockaddr_in {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_SHORT.withName("sin_family"),
        uring_syscalls_h.C_SHORT.withName("sin_port"),
        in_addr.layout().withName("sin_addr"),
        MemoryLayout.sequenceLayout(8, uring_syscalls_h.C_CHAR).withName("sin_zero")
