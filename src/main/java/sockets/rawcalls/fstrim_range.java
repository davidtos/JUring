...
public class fstrim_range {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_LONG_LONG.withName("len"),
        uring_syscalls_h.C_LONG_LONG.withName("minlen")
    ...
    private static final long minlen$OFFSET = $LAYOUT.byteOffset(groupElement("minlen"));
