...
public class fsuuid2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_CHAR.withName("len"),
        MemoryLayout.sequenceLayout(16, uring_syscalls_h.C_CHAR).withName("uuid")
    ).withName("fsuuid2");
    ...
    private static final long uuid$OFFSET = $LAYOUT.byteOffset(groupElement("uuid"));
