...
public class sockaddr_in6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_SHORT.withName("sin6_family"),
        uring_syscalls_h.C_SHORT.withName("sin6_port"),
        uring_syscalls_h.C_INT.withName("sin6_flowinfo"),
        in6_addr.layout().withName("sin6_addr"),
        uring_syscalls_h.C_INT.withName("sin6_scope_id")
