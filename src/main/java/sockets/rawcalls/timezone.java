...
public class timezone {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("tz_minuteswest"),
        uring_syscalls_h.C_INT.withName("tz_dsttime")
    ).withName("timezone");
    ...
    private static final long tz_minuteswest$OFFSET = $LAYOUT.byteOffset(groupElement("tz_minuteswest"));
    ...
    private static final long tz_dsttime$OFFSET = $LAYOUT.byteOffset(groupElement("tz_dsttime"));
