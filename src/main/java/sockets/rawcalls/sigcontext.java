...
public class sigcontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG_LONG.withName("fault_address"),
        MemoryLayout.sequenceLayout(31, uring_syscalls_h.C_LONG_LONG).withName("regs"),
        uring_syscalls_h.C_LONG_LONG.withName("sp"),
        uring_syscalls_h.C_LONG_LONG.withName("pc"),
        uring_syscalls_h.C_LONG_LONG.withName("pstate"),
        MemoryLayout.paddingLayout(8),
        MemoryLayout.sequenceLayout(4096, uring_syscalls_h.C_CHAR).withName("__reserved")
    ).withName("sigcontext");
    ...
    private static final long fault_address$OFFSET = $LAYOUT.byteOffset(groupElement("fault_address"));
    ...
    private static final long regs$OFFSET = $LAYOUT.byteOffset(groupElement("regs"));
    ...
    private static final long pstate$OFFSET = $LAYOUT.byteOffset(groupElement("pstate"));
