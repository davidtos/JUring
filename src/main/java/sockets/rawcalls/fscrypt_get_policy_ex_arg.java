...
public class fscrypt_get_policy_ex_arg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG_LONG.withName("policy_size"),
    ...
    private static final long policy_size$OFFSET = $LAYOUT.byteOffset(groupElement("policy_size"));
    ...
    private static final long policy$OFFSET = $LAYOUT.byteOffset(groupElement("policy"));
