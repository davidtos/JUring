...
public class io_uring_napi {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("busy_poll_to"),
        uring_syscalls_h.C_CHAR.withName("prefer_busy_poll"),
        MemoryLayout.sequenceLayout(3, uring_syscalls_h.C_CHAR).withName("pad"),
        uring_syscalls_h.C_LONG_LONG.withName("resv")
    ...
    private static final long busy_poll_to$OFFSET = $LAYOUT.byteOffset(groupElement("busy_poll_to"));
    ...
    private static final long prefer_busy_poll$OFFSET = $LAYOUT.byteOffset(groupElement("prefer_busy_poll"));
