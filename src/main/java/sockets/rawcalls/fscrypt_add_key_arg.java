...
public class fscrypt_add_key_arg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_INT.withName("raw_size"),
        uring_syscalls_h.C_INT.withName("key_id"),
        MemoryLayout.sequenceLayout(8, uring_syscalls_h.C_INT).withName("__reserved"),
        MemoryLayout.sequenceLayout(0, uring_syscalls_h.C_CHAR).withName("raw")
    ...
    private static final long raw_size$OFFSET = $LAYOUT.byteOffset(groupElement("raw_size"));
