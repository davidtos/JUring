...
public class file_dedupe_range {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_SHORT.withName("dest_count"),
        uring_syscalls_h.C_SHORT.withName("reserved1"),
        uring_syscalls_h.C_INT.withName("reserved2"),
    ...
    private static final long dest_count$OFFSET = $LAYOUT.byteOffset(groupElement("dest_count"));
