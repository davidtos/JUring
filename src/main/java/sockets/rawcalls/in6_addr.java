...
public class in6_addr {
    ...
    public static class __in6_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(16, uring_syscalls_h.C_CHAR).withName("__u6_addr8"),
            MemoryLayout.sequenceLayout(8, uring_syscalls_h.C_SHORT).withName("__u6_addr16"),
            MemoryLayout.sequenceLayout(4, uring_syscalls_h.C_INT).withName("__u6_addr32")
        ).withName("$anon$225:5");
    ...
    private static final long __in6_u$OFFSET = $LAYOUT.byteOffset(groupElement("__in6_u"));
