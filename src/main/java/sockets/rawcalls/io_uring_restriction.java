...
public class io_uring_restriction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_SHORT.withName("opcode"),
        MemoryLayout.unionLayout(
            uring_syscalls_h.C_CHAR.withName("register_op"),
            uring_syscalls_h.C_CHAR.withName("sqe_op"),
            uring_syscalls_h.C_CHAR.withName("sqe_flags")
        ).withName("$anon$719:2"),
        uring_syscalls_h.C_CHAR.withName("resv"),
        MemoryLayout.sequenceLayout(3, uring_syscalls_h.C_INT).withName("resv2")
    ...
    private static final OfByte register_op$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$719:2"), groupElement("register_op"));
    ...
    private static final long register_op$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$719:2"), groupElement("register_op"));
    ...
    private static final OfByte sqe_op$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$719:2"), groupElement("sqe_op"));
    ...
    private static final long sqe_op$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$719:2"), groupElement("sqe_op"));
    ...
    private static final OfByte sqe_flags$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$719:2"), groupElement("sqe_flags"));
    ...
    private static final long sqe_flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$719:2"), groupElement("sqe_flags"));
    ...
    private static final long resv$OFFSET = $LAYOUT.byteOffset(groupElement("resv"));
    ...
    private static final long resv2$OFFSET = $LAYOUT.byteOffset(groupElement("resv2"));
