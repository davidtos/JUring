...
public class io_uring_cqe {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_INT.withName("res"),
        uring_syscalls_h.C_INT.withName("flags"),
        MemoryLayout.sequenceLayout(0, uring_syscalls_h.C_LONG_LONG).withName("big_cqe")
    ...
    private static final long res$OFFSET = $LAYOUT.byteOffset(groupElement("res"));
    ...
    private static final long big_cqe$OFFSET = $LAYOUT.byteOffset(groupElement("big_cqe"));
