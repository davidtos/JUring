...
public class fscrypt_key_specifier {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("type"),
        uring_syscalls_h.C_INT.withName("__reserved"),
        u.layout().withName("u")
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(32, uring_syscalls_h.C_CHAR).withName("__reserved"),
            MemoryLayout.sequenceLayout(8, uring_syscalls_h.C_CHAR).withName("descriptor"),
            MemoryLayout.sequenceLayout(16, uring_syscalls_h.C_CHAR).withName("identifier")
        ).withName("$anon$109:2");
