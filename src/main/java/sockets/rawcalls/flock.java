...
public class flock {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_SHORT.withName("l_type"),
        uring_syscalls_h.C_SHORT.withName("l_whence"),
        MemoryLayout.paddingLayout(4),
        uring_syscalls_h.C_LONG.withName("l_start"),
        uring_syscalls_h.C_LONG.withName("l_len"),
        uring_syscalls_h.C_INT.withName("l_pid"),
        MemoryLayout.paddingLayout(4)
    ).withName("flock");
