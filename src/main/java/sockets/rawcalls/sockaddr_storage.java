...
public class sockaddr_storage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_SHORT.withName("ss_family"),
        MemoryLayout.sequenceLayout(118, uring_syscalls_h.C_CHAR).withName("__ss_padding"),
        uring_syscalls_h.C_LONG.withName("__ss_align")
    ...
    private static final long __ss_padding$OFFSET = $LAYOUT.byteOffset(groupElement("__ss_padding"));
