...
public class zt_context {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_SHORT.withName("nregs"),
        MemoryLayout.sequenceLayout(3, uring_syscalls_h.C_SHORT).withName("__reserved")
    ).withName("zt_context");
    ...
    private static final long nregs$OFFSET = $LAYOUT.byteOffset(groupElement("nregs"));
