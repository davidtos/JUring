...
public class io_uring_probe {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_CHAR.withName("last_op"),
        uring_syscalls_h.C_CHAR.withName("ops_len"),
        uring_syscalls_h.C_SHORT.withName("resv"),
    ...
    private static final long last_op$OFFSET = $LAYOUT.byteOffset(groupElement("last_op"));
    ...
    private static final long ops_len$OFFSET = $LAYOUT.byteOffset(groupElement("ops_len"));
