...
public class __kernel_fd_set {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, uring_syscalls_h.C_LONG).withName("fds_bits")
    ).withName("$anon$25:9");
    ...
    private static final long fds_bits$OFFSET = $LAYOUT.byteOffset(groupElement("fds_bits"));
