...
public class io_uring_buf_reg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG_LONG.withName("ring_addr"),
        uring_syscalls_h.C_INT.withName("ring_entries"),
        uring_syscalls_h.C_SHORT.withName("bgid"),
        uring_syscalls_h.C_SHORT.withName("flags"),
        MemoryLayout.sequenceLayout(3, uring_syscalls_h.C_LONG_LONG).withName("resv")
    ...
    private static final long ring_addr$OFFSET = $LAYOUT.byteOffset(groupElement("ring_addr"));
    ...
    private static final long bgid$OFFSET = $LAYOUT.byteOffset(groupElement("bgid"));
