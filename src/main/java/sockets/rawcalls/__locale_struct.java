...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, uring_syscalls_h.C_POINTER).withName("__locales"),
        uring_syscalls_h.C_POINTER.withName("__ctype_b"),
        uring_syscalls_h.C_POINTER.withName("__ctype_tolower"),
        uring_syscalls_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, uring_syscalls_h.C_POINTER).withName("__names")
