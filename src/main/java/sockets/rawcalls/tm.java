...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_INT.withName("tm_sec"),
        uring_syscalls_h.C_INT.withName("tm_min"),
        uring_syscalls_h.C_INT.withName("tm_hour"),
        uring_syscalls_h.C_INT.withName("tm_mday"),
        uring_syscalls_h.C_INT.withName("tm_mon"),
        uring_syscalls_h.C_INT.withName("tm_year"),
        uring_syscalls_h.C_INT.withName("tm_wday"),
        uring_syscalls_h.C_INT.withName("tm_yday"),
        uring_syscalls_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        uring_syscalls_h.C_LONG.withName("tm_gmtoff"),
        uring_syscalls_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
