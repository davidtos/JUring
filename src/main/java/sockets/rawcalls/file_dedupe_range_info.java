...
public class file_dedupe_range_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG_LONG.withName("dest_fd"),
        uring_syscalls_h.C_LONG_LONG.withName("dest_offset"),
        uring_syscalls_h.C_LONG_LONG.withName("bytes_deduped"),
        uring_syscalls_h.C_INT.withName("status"),
        uring_syscalls_h.C_INT.withName("reserved")
    ...
    private static final long dest_fd$OFFSET = $LAYOUT.byteOffset(groupElement("dest_fd"));
    ...
    private static final long bytes_deduped$OFFSET = $LAYOUT.byteOffset(groupElement("bytes_deduped"));
