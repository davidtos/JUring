...
public class sve_context {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        uring_syscalls_h.C_SHORT.withName("vl"),
        uring_syscalls_h.C_SHORT.withName("flags"),
        MemoryLayout.sequenceLayout(2, uring_syscalls_h.C_SHORT).withName("__reserved")
    ...
    private static final long vl$OFFSET = $LAYOUT.byteOffset(groupElement("vl"));
