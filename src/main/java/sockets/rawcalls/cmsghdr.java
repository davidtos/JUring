...
public class cmsghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        uring_syscalls_h.C_LONG.withName("cmsg_len"),
        uring_syscalls_h.C_INT.withName("cmsg_level"),
        uring_syscalls_h.C_INT.withName("cmsg_type"),
        MemoryLayout.sequenceLayout(0, uring_syscalls_h.C_CHAR).withName("__cmsg_data")
    ).withName("cmsghdr");
    ...
    private static final long cmsg_len$OFFSET = $LAYOUT.byteOffset(groupElement("cmsg_len"));
    ...
    private static final long cmsg_level$OFFSET = $LAYOUT.byteOffset(groupElement("cmsg_level"));
    ...
    private static final long cmsg_type$OFFSET = $LAYOUT.byteOffset(groupElement("cmsg_type"));
    ...
    private static final long __cmsg_data$OFFSET = $LAYOUT.byteOffset(groupElement("__cmsg_data"));
